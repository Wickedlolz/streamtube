...
const HeroCarousel = () => {
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center h-[400px] lg:h-[700px] bg-gray-900 text-white">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-t-4 border-white border-opacity-50 mx-auto"></div>
          <p className="mt-4 text-lg font-semibold">Loading movies...</p>
        </div>
      </div>
    );
  }
  ...
  if (isError) {
    return (
      <div className="flex items-center justify-center h-[400px] lg:h-[700px] bg-red-600 text-white">
        <div className="text-center">
  ...
  return (
    ...
    >
      <CarouselContent className="-ml-2 md:-ml-4">
        {data?.map((movie) => (
          <CarouselItem key={movie.id} className="pl-2 md:pl-4 relative group">
            <Link
            ...
            >
              ...
              />
              <div className="inline absolute top-0 pt-40 xl:pt-72 left-0 bg-transparent z-20 h-full w-full bg-gradient-to-r from-gray-900/90 via-transparent to-transparent p-16 space-y-5 text-white">
