          ...
          <CarouselItem key={movie.id} className="pl-2 md:pl-4 relative group">
            ...
            >
              ...
              <Image
                ...
                width={1920}
                height={550}
                priority={data?.indexOf(movie) === 0}
                className="w-full h-[400px] lg:h-[550px] object-cover"
              />
              <div className="inline absolute top-0 pt-40 xl:pt-56 left-0 bg-transparent z-20 h-full w-full bg-linear-to-r from-gray-900/90 via-transparent to-transparent p-20 space-y-5 text-white">
